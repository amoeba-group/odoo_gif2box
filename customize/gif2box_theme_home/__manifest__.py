{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'gif2box_theme_home/static/src/scss/policy_page.scss',
            'gif2box_theme_home/static/src/scss/cart_notification.scss',
            ...
            'gif2box_theme_home/static/src/js/policy_page.js',
            'gif2box_theme_home/static/src/js/product_configurator_title.js',
            'gif2box_theme_home/static/src/xml/configurator_buttons.xml',
        ],
    },
    'installable': True,
    'auto_install': False,
